...
public class ManageProject extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        clientContact.setText("clientContact");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(client, javax.swing.GroupLayout.PREFERRED_SIZE, 19, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {                                           
        ...
        if(!eDate.after(sDate)){
            JOptionPane.showMessageDialog(null, "Project End Date can not be before Start date!");
            return;            
        }
        Date today = new Date();
        if(eDate.compareTo(today)<0){
            JOptionPane.showMessageDialog(null, "Project End Date should be after Today!");
            return;            
        }
    ...
    private void selectProjectComboBoxActionPerformed(java.awt.event.ActionEvent evt) {                                                      
