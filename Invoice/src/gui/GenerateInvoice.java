...
public class GenerateInvoice extends javax.swing.JPanel {
    ...
    List<Long> projectPersonClockedHoursList;
    ...
    public GenerateInvoice(JFrame  panelHolder, SystemData systemData) {
        ...
        //System.out.p//System.out.println("inv"+invoiceDate);
...
//            //System.out.println(projectPersonList);
            projectPersonClockedHoursList = new ArrayList<>(projectPersonList.size());
            ...
            for (ProjectPerson projectPerson : projectPersonList) {
                ...
                projectPersonClockedHoursList.add(totalHours);                
            }
            //System.out.println(projectPersonList);
            //System.out.println(projectPersonClockedHoursList);
...
//            //System.out.println(projectPersonList);
            ...
            for (ProjectPerson projectPerson : projectPersonList) {
                InvoiceLineItem invoiceLineItem = new InvoiceLineItem(invoice.getId(), 
                        ...
                        projectPersonClockedHoursList.get(j), 
                        projectPersonClockedHoursList.get(j)*projectPerson.getProjectPersonName().getBillRate());
