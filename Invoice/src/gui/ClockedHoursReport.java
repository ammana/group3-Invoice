...
public class ClockedHoursReport extends javax.swing.JPanel {    
    JFrame  panelHolder;
    SystemData systemData;
    DefaultTableModel tableModel;
    Calendar selectedWeekStartDate;
    
    public ClockedHoursReport(JFrame  panelHolder, SystemData systemData) {
	...
	calendar.set(Calendar.DAY_OF_WEEK, 1);
        ...
        Query query = em.createQuery("Select wh from ClockedHours wh where " 
